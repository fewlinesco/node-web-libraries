...
type GetUsersByIdParams = { id: string };
...
class UserNotFoundError extends WebError {}

function getUserById(tracer: Tracer) {
...
type CreateUserParams = Record<string, unknown>;
interface CreateUserBody {
  name: string;
}

class ParameterError extends WebError {}

function createUser(tracer: Tracer) {
  return (request: Request, response: Response): Promise<void> => {
...
export type { GetUsersByIdParams, CreateUserBody, CreateUserParams };

export { UserNotFoundError, getUserById, ParameterError, createUser };
